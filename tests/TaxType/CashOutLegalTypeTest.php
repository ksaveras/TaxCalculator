...
use App\TaxType\CashOutLegalType;
use App\TaxType\TaxTypeInterface;
use Money\Money;
use PHPUnit\Framework\TestCase;

/**
 * Class CashOutLegalTypeTest.
 */
class CashOutLegalTypeTest extends TestCase
{
    /**
    ...
    {
        $type = new CashOutLegalType($this->getTaxTypeMock());
    ...
    public function testCalculationInvalidContext(): void
    {
        ...
        $type = new CashOutLegalType($taxMock);
    ...
    public function testTaxTypeCall(): void
    {
        ...
        $type->calculateTax(
            Money::EUR(100),
            new OperationContext((new User())->setType(UserType::LEGAL()), new \DateTime(), OperationType::CASH_OUT())
        );
    }
